...
- Before [gazebo_yarp_plugins](https://github.com/robotology/gazebo-yarp-plugins) compiling upgrade boost by following instructions [here](https://codeyarns.com/2013/12/27/how-to-upgrade-the-boost-library-on-ubuntu/).
