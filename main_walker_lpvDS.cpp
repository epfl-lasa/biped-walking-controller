...
int main(int argc, char **argv) //(int argc, char *argv[])
{
    ...
    // Parameters to load LPV-DS model
    std::string path_to_models    = rf.check("path_to_models",           Value(""), "Looking for module name").asString();
    std::string lpvDS_model_name  = rf.check("lpvDS_model_name",          Value(""), "Looking for robot name").asString();
    ...
    // =======================================================
    DesVelocityCommand_lpvDS myDesiredCoM( m_moduleName, m_robotName, DSType, path_to_models, lpvDS_model_name); 
